...
import tk.sciwhiz12.janitor.api.utils.CommandHelper;
import tk.sciwhiz12.janitor.api.utils.MessageHelper;
import tk.sciwhiz12.janitor.api.command.arguments.GuildMemberArgument;
...
public class KickCommand extends ModBaseCommand {
    ...
    public LiteralArgumentBuilder<MessageReceivedEvent> getNode() {
        return CommandHelper.literal("kick")
            .then(
                CommandHelper.argument("member", GuildMemberArgument.member())
                    .then(
    ...
    private int runWithReason(CommandContext<MessageReceivedEvent> ctx, @Nullable String reason) throws CommandSyntaxException {
        ...
        final List<Member> members = GuildMemberArgument.getMembers("member", ctx).fromGuild(performer.getGuild());
