package tk.sciwhiz12.janitor.core.messages.json;
...
import tk.sciwhiz12.janitor.core.utils.DeserializerUtil;
...
public class ListingMessageDeserializer extends StdDeserializer<ListingMessage> {
    ...
    public ListingMessage deserialize(JsonParser p, DeserializationContext ctx)
        ...
        List<MessageEmbed.Field> beforeFields = DeserializerUtil.readFields(root.path("fields").path("before"));
        List<MessageEmbed.Field> afterFields = DeserializerUtil.readFields(root.path("fields").path("after"));
